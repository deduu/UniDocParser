...
def extract_images_from_figures(fig2tab_model, pages, figure_list):
    """ 
    Extracts images from the figure list and updates the pages with generated text and metadata.
    Args:
        fig2tab_model: The model provider instance to use for generation.
    ...
    for i, image in enumerate(figure_list):
        ...
        # The model provider has the methods defined in the interface
